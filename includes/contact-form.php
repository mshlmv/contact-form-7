...
class WPCF7_ContactForm {
    ...
    if ($this->wpcf7_to_quest) {
      $html .= '<div class="answer_to_quest" style="font-size: 11px">Сообщение отправится в <a href="/category/forum/" target="_blank">Вопрос-Ответ</a> <input type="checkbox" name="answer_to_quest" value="1" checked></div>';
    }
